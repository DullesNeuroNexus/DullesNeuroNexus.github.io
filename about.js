...
for(let member of members){
    ...
    `;
    if (member.mail) out += `<a href = "${member.mail}" class="gridtext-link"><p class="gridtext-contact">Gmail: ${member.mail}</p></a>`;
